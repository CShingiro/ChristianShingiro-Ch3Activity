...
if (scores.length > 0) {
    ...
    // let highestScore = 0;
    // for of loop here to calculate my highest score
    //for(let x of scores) {
        // check for the highest score
        // if (x > highestScore) {
            // assign the highest score
            // highestScore = x;
    ...
    // display the highest score here
    document.write(`<h3>Highest Score is ${highestScore}</h3>`);
